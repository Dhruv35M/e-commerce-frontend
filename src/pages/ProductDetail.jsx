...
import { getRandomCategory, productCategory } from "../helpers/productCategory";
import ProductsSuggestion from "../components/ProductsSuggestion";
  ...
  const fetchProductDetails = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const imageUrls = dataResponse.image
          ? dataResponse?.image.split(",")
          : [];
        setData({
          ...dataResponse,
          image: imageUrls,
  ...
  return (
    <div className="container mx-auto p-4">
        ...
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4">
          ...
          {/* <div
            ...
            style={{
              width: "50px",
              height: "50px",
              left: `${zoomImageCoordinate.x * 100 - 50}%`, // Center the box around the cursor horizontally
              top: `${zoomImageCoordinate.y * 100 - 50}%`, // Center the box around the cursor vertically
            }}
          ></div> */}
      ...
      <ProductsSuggestion
        ...
        heading={"Products that you may like"}
      />
    </div>
  );
};
